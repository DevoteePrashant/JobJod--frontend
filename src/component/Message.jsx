          ...
          <div className="flex justify-center items-center p-4 border-t border-gray-200">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 text-sm border border-gray-200 rounded-lg pr-24"
                value={message}
                onChange={(e) => setMessage(e.target.value)}
              />
              <div className="absolute right-2 top-2 flex items-center space-x-2">
             {/* <button type="file" id="myfile" name="myfile"  className="text-gray-400 hover:text-gray-600">📎</button> */}
             <input
            type="file"
            id="fileInput"
            ref={fileInputRef}
