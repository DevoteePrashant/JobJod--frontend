      ...
      <div className="bg-white rounded-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              <label htmlFor="minimum-age" className="text-sm font-medium">
                Minimum Age Required
              </label>
              <div
              ...
              >
                <span className="text-sm text-gray-600">{minimumAge || "Select age"}</span>
...
<div className="mb-8">
  <h2 className="text-lg font-medium mb-6">Description & Skills</h2>
  ...
  <div className="mb-4">
    <h3 className="text-gray-600 mb-6">Responsibility</h3>
    <textarea
