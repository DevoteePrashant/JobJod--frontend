...
export const DashboardSidebar = ({ profile, isOpen, onClose }) => {
    const location = useLocation()
    const substrLocation = location.pathname.substring(1)
    const getHeaderStyle = (header) => `${substrLocation.toLowerCase() === header.toLowerCase() ? 'bg-gray-900 text-white hover:bg-gray-900 hover:text-white' : 'text-black bg-white'} flex items-center p-2 rounded-xl text-sm font-medium hover:text-black  bg-gray-800 hover:bg-gray-100 `
