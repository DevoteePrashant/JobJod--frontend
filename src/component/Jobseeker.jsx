  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="rounded-xl border bg-white p-6">
            ...
            <div className="space-y-3">
              <div className="rounded-lg p-3 hover:bg-gray-50 border border-gray-100">
                <p className="text-sm">Your application was viewed by Grameenphone, Your application was viewed by Grameenphone</p>
                <p className="text-xs text-gray-500 mt-1">2 hours ago</p>
              </div>
              <div className="rounded-lg p-3 hover:bg-gray-50 border border-gray-100">
                <p className="text-sm">New job matching your profile: UX Designer at Alpha,New job matching your profile: UX Designer at Alpha</p>
        ...
        {/* Applied Jobs Section - 20% */}
        <div className="w-full lg:w-[30%] rounded-xl border bg-white p-3 h-full">
