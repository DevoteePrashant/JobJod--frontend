        ...
        `}
            >
                ...
                <nav className="flex-1 p-4 mt-6">
                    <ul>
                        <li className="mb-2">
                            <Link to="/CompanyDashboard" className="flex items-center p-2 rounded-xl text-sm font-medium  text-gray-700 hover:bg-gray-100">
                                <RxDashboard className="mr-2" /> <span className="m-auto">Dashboard</span>
                            </Link>
                        </li>
                        <li className="mb-2">
                            <Link to="/CompanyPostJobs" className="flex items-center p-2 rounded-xl text-sm font-medium  text-white bg-gray-900 hover:bg-gray-800 ">
                                <PiBagSimpleFill className="mr-2" />  <span className="m-auto">Jobs</span>
                            </Link>
                        </li>
                        <li className="mb-2">
                            <Link to="/CompanyApplications" className="flex items-center p-2 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-100">
                                <PiMonitorFill className="mr-2" /> <span className="m-auto">Applications</span>
                            </Link>
                        </li>
                        <li className="mb-2">
                            <Link to="/CompanyProfile" className="flex items-center p-2 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-100 ">
...
<div className="lg:hidden bg-white border-b border-gray-200 p-4">
  <button className="w-full py-2 px-4 bg-white text-purple-500 border border-purple-500 rounded-xl flex items-center justify-center">
...
<div className="lg:flex">
  ...
  <div className="hidden lg:block w-full lg:w-1/4 bg-white border-r border-gray-200 p-4" style={{ overflowY: 'auto', scrollbarWidth: 'none' }}>
    <button className="w-full py-2 px-4 bg-white text-purple-500 border border-purple-500 rounded-xl mb-6 flex items-center justify-center">
      <span>Post New Job</span>
      <PlusIcon className="h-4 w-4 ml-1" />
    </button>
    {/* Job List */}
    <div className="space-y-4">
      {[1, 2, 3].map((item) => (
        <div key={item} className="p-3 bg-indigo-50 rounded-md">
          ...
          <p className="text-sm text-gray-500"><span className="font-semibold">Grameenphone</span>&nbsp;&nbsp;   Dhaka, Bangladesh</p>
        </div>
      ))}
    </div>
  </div>
  ...
  {/* Job Details */}
  <div className="flex-1 p-4 lg:p-6 bg-white overflow-y-auto" style={{ overflowY: 'auto', scrollbarWidth: 'none' }}>
    {/* Header Stats */}
    ...
    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-2">
      <h1 className="text-xl lg:text-2xl font-bold mb-1 lg:mb-0">Product Designer</h1>
    ...
    <div className="flex items-center mb-2">
      <div className="bg-white p-1 rounded mr-2">
          <img src={t1} alt="icon" className="h-4 w-4 text-purple-500" />
      </div>
      <span className="text-gray-700 font-semibold">Grameenphone</span>
      <span className="text-gray-500 ml-1">Dhaka, Bangladesh</span>
    </div>

    {/* Job Dates */}
    <p className="text-gray-500 text-sm mb-4 lg:mb-6">Posted on 15 May 20 · Expire on 30 May 20</p>
    ...
    <div className="mb-4 lg:mb-6 font-semibold">
      ...
      <ul className="list-disc pl-5 lg:pl-6 space-y-2">
        ...
        <li className="text-gray-700">Participate in user-experience research and usability studies.</li>
      </ul>
    </div>

    {/* Qualifications Section */}
    <div className="mb-4 lg:mb-6 font-semibold">
      <h2 className="text-lg font-medium mb-2">Qualifications and Skills</h2>
      <ul className="list-disc pl-5 lg:pl-6 space-y-2">
        <li className="text-gray-700">
        ...
        <li className="text-gray-700">Portfolio of UX design work.</li>
        <li className="text-gray-700">
    ...
    <div className="mb-4 lg:mb-6 font-semibold pb-4 lg:pb-8">
      <h2 className="text-lg font-medium mb-2">Preferred Qualifications and Skills</h2>
      <ol className="list-decimal pl-5 lg:pl-6 space-y-2">
        ...
        <li className="text-gray-700">Experience designing for wearable devices.</li>
        <li className="text-gray-700">Experience with prototyping.</li>
        <li className="text-gray-700">
