...
const Messages = () => {
  ...
  const chatMessages = [
    {
      ...
      sender: "other",
      message:
        "Keeping this in mind, Grameenphone always brings future-proof technology in order to facilitate your progress.",
    ...
    },
    {
      ...
      sender: "me",
      message:
        "My goal was to craft a functional and delightful experience through web and mobile apps currently consisting of 1.2M+ & future billion users.",
      timestamp: "May 21, 2020, 7:51 PM"
    },
    // Adding more messages to demonstrate scrolling
    {
  ...
  {/* Left Side: ChevronLeft and Avatar */}
  ...
  return (
    <>
      <Navbar />
      <div className="lg:ms-16 lg:me-16 flex flex-col h-[calc(100vh-64px)] bg-[#F2F2F7]">
