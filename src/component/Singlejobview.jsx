...
//                   <div className="text-sm font-medium text-gray-800">Product Designer</div>
//                   <div className="text-xs text-gray-500"><span className='font-semibold text-black'>Grameenphone</span> Dhaka, Bangladesh</div>
//                   <div className="text-xs text-black flex mt-2 font-semibold"><img src={star} alt="star" className="mr-1 h-4 w-4" />Interview</div>
//                 </div>
//               </div>
//               <div className="flex items-center py-2 cursor-pointer hover:bg-blue-50">
//                 <img
...
//             {/* Job Title and Location */}
            ...
            //     <Link to="/Singlejobviews"><button className="bg-purple-500 text-white rounded-xl px-6 py-2 text-sm font-medium mr-2">
            //       Apply Now
            //     </button>
            //     </Link>
            //     <Link to="/Singlejobviews"><button className="bg-black text-white rounded-xl px-5 py-2 text-sm font-medium">
            //       Save
            //     </button>
            //     </Link>
...
//         <Link href="##" className="text-purple-400 text-sm font-bold md:self-start">
//           View Page
//         </Link>
//       </div>
